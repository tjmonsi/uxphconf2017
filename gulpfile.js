...
gulp.task('inject-all',  gulp.series(['inject-sass', 'inject-home', 'inject-metadata']));

gulp.task('watch-all', function(cb) {

  gulp.watch(['pages/**/*.scss', 'web-components/**/*.scss', 'styles/**/*.scss', 'config/**/*.json', 'home-page.html'],
